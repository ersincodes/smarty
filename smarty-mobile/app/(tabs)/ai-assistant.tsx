...
const styles = StyleSheet.create({
  ...
  instructionIconContainer: {
    backgroundColor: Colors.intelligence[100] || Colors.primary[100],
    borderRadius: 24,
    padding: 16,
    marginBottom: 24,
  },
  ...
  chatButton: {
    backgroundColor: Colors.intelligence[600] || Colors.primary[600],
    borderRadius: 12,
    paddingVertical: 8,
    paddingHorizontal: 24,
    shadowColor: Colors.intelligence[700] || Colors.primary[700],
